...
public class UnitScript1 : MonoBehaviour
{
    public int teamNum;
    public int x;
    public int y;
    ...
    {
        healthBarCanvas.transform.forward = UnityEngine.Camera.main.transform.forward;
        holder2D.transform.forward = UnityEngine.Camera.main.transform.forward;
    }
    ...
    public IEnumerator moveOverSeconds(GameObject objectToMove, Node endNode)
    {
        ...
        x = endNode.x;
        y = endNode.y;
        tileBeingOccupied.GetComponent<ClickableTileScript1>().unitOnTile = null;
